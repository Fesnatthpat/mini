...
if (isset($_GET['delete'])) { // ตรวจสอบว่ามีการส่งค่า 'delete' ผ่าน URL หรือไม่
    ...
    $deletestmt = $pdo->prepare("DELETE FROM room WHERE room_id = ?"); // เตรียมคำสั่ง SQL สำหรับลบข้อมูลจากตาราง 'room' โดยอ้างอิงจาก 'room_id'
    ...
    if ($deletestmt) { // ตรวจสอบว่าการลบข้อมูลสำเร็จหรือไม่
        ...
        header("refresh:1; url=data-classroom.php"); // รีเฟรชหน้าเพื่อนำผู้ใช้กลับไปยังหน้า 'data-classroom.php' หลังจาก 1 วินาที
