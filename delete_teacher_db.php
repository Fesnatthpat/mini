...
if (isset($_GET['delete'])) { // ตรวจสอบว่ามีการส่งค่า 'delete' ผ่าน URL หรือไม่
    ...
    $deletestmt = $pdo->prepare("DELETE FROM teacher WHERE t_id = ?"); // เตรียมคำสั่ง SQL สำหรับลบข้อมูลจากตาราง 'teacher' โดยอ้างอิงจาก 't_id'
    ...
    if ($deletestmt) { // ตรวจสอบว่าการลบข้อมูลสำเร็จหรือไม่
        ...
        header("refresh:1; url=teacher.php"); // รีเฟรชหน้าเพื่อนำผู้ใช้กลับไปยังหน้า 'teacher.php' หลังจาก 1 วินาที
