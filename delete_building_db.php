...
if (isset($_GET['delete'])) { // ตรวจสอบว่ามีการส่งค่า 'delete' ผ่าน URL หรือไม่
    ...
    $deletestmt = $pdo->prepare("DELETE FROM building WHERE building_id = ?"); // เตรียมคำสั่ง SQL สำหรับลบข้อมูลจากตาราง 'building' โดยอ้างอิงจาก 'building_id'
    ...
    if ($deletestmt) { // ตรวจสอบว่าการลบข้อมูลสำเร็จหรือไม่
        ...
        header("refresh:0; url=building.php"); // รีเฟรชหน้าเพื่อนำผู้ใช้กลับไปยังหน้า 'building.php'
