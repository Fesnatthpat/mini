...
$searchLevel = isset($_POST['search_level']) ? $_POST['search_level'] : ''; // รับค่าระดับชั้น
$searchSemester = isset($_POST['search_semester']) ? $_POST['search_semester'] : ''; // รับค่าภาคเรียน
$searchYear = isset($_POST['search_year']) ? $_POST['search_year'] : ''; // รับค่าปีการศึกษา
...
$sql = "SELECT s.schedule_id, sj.subject_name, sj.subject_code, sj.subject_id, t.t_id, t.fullname, s.teacher_time, r.room_id, r.room_no
        ...
        WHERE 1"; // คำสั่ง SQL เริ่มต้นที่ไม่มีเงื่อนไข
...
if (!empty($searchLevel) && !empty($searchSemester) && !empty($searchYear)) {
    $title = "ตารางสอน ภาคเรียนที่{$searchSemester} ปีการศึกษา{$searchYear} ระดับชั้น {$searchLevel}"; // กำหนดหัวข้อหากมีการกรอกทั้งหมด
} elseif (!empty($searchLevel) && !empty($searchSemester)) {
    $title = "ตารางสอน ภาคเรียนที่{$searchSemester} ระดับชั้น {$searchLevel}"; // กำหนดหัวข้อหากกรอกระดับชั้นและภาคเรียน
} elseif (!empty($searchLevel) && !empty($searchYear)) {
    $title = "ตารางสอน ปีการศึกษา{$searchYear} ระดับชั้น {$searchLevel}"; // กำหนดหัวข้อหากกรอกระดับชั้นและปีการศึกษา
} elseif (!empty($searchSemester) && !empty($searchYear)) {
    $title = "ตารางสอน ภาคเรียนที่{$searchSemester} ปีการศึกษา{$searchYear}"; // กำหนดหัวข้อหากกรอกภาคเรียนและปีการศึกษา
} elseif (!empty($searchLevel)) {
    $title = "ตารางสอน ระดับชั้น {$searchLevel}"; // กำหนดหัวข้อหากกรอกระดับชั้น
} elseif (!empty($searchSemester)) {
    $title = "ตารางสอน ภาคเรียนที่{$searchSemester}"; // กำหนดหัวข้อหากกรอกภาคเรียน
} elseif (!empty($searchYear)) {
    $title = "ตารางสอน ปีการศึกษา{$searchYear}"; // กำหนดหัวข้อหากกรอกปีการศึกษา
}
?>
