...
if (isset($_GET['delete'])) { // ตรวจสอบว่ามีการส่งค่า 'delete' ผ่าน URL หรือไม่
    ...
    $deletestmt = $pdo->prepare("DELETE FROM subject WHERE subject_id = ?"); // เตรียมคำสั่ง SQL สำหรับลบข้อมูลจากตาราง 'subject' โดยอ้างอิงจาก 'subject_id'
    ...
    if ($deletestmt) { // ตรวจสอบว่าการลบข้อมูลสำเร็จหรือไม่
        ...
        header("refresh:1; url=data-subject.php"); // รีเฟรชหน้าเพื่อนำผู้ใช้กลับไปยังหน้า 'data-subject.php' หลังจาก 1 วินาที
